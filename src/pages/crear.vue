            ...
            <div class="card-body my-2">
                <form v-on:submit.prevent="crearPqr">
                    ...
                    <div class="my-3">
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input type="text" class="form-control is-invalid" v-model="pqrs.identificacion" id="floatingInputGroup2"
                    ...
                    <div class="my-3">
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input type="text" class="form-control is-invalid" v-model="pqrs.nombres_apellidos" id="floatingInputGroup2"
                    ...
                    <div class="my-3">
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input type="text" class="form-control is-invalid" v-model="pqrs.email" id="floatingInputGroup2"
                    ...
                    <div class="my-3">
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input type="text" class="form-control is-invalid" v-model="pqrs.tel" id="floatingInputGroup2" 
