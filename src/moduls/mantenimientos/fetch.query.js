/* const url = 'https://portadainmobiliaria.cloud/api/v1.1/mantenimiento/'
...
export function cargarDatosMantenimiento(id) {
...
export function actualizarMantenimiento(datosEnviar) {
...
export default cargarDatosMantenimiento